...
export default function PrescriptionBell({ onLoad }: Props) {
  ...
  const panel = open ? (
    <>
      ...
      <div
        className="fixed z-[210] bg-white rounded-2xl shadow-2xl border border-slate-200 overflow-hidden flex flex-col max-h-[min(85vh,calc(100vh-24px))]"
        style={{ top: panelPos.top, left: panelPos.left, width: Math.min(PANEL_WIDTH, window.innerWidth - 16) }}
      >
        ...
        <div className="overflow-y-auto divide-y divide-slate-100 min-h-0 flex-1">
